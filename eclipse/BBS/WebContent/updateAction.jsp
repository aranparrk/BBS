...
<body>
	...
	if (!userID.equals(bbs.getUserID())) {
		...
		if (request.getParameter("bbsTitle") == null || request.getParameter("bbsContent") == null || request.getParameter("bbsTitle").equals("") || request.getParameter("bbsContent").equals("")) { // null이거나 빈칸일 때
			PrintWriter script = response.getWriter();
			script.println("<script>");
			...
			int result = bbsDAO.update(bbsID, request.getParameter("bbsTitle"), request.getParameter("bbsContent")); // 게시글을 작성할 수 있게 해준다, 차례대로 매개변수를 넣어준다
